          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ url('admin/uploaddata/commercial/upload') }}" class="dropzone" id="upload-dropzone">
                  @csrf
                </form>
              </div>
        ...
        buttons: [            
            ...
            },
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('admin/uploaddata/commercial/csvall') }}'
              }
            },
            {
    ...
    $('.buttons-deletemulti').click(function(){
      ...
      if(deletedates_arr.length > 0){
        ...
        if (confirmdelete == true) {
          window.location = '{{ url('admin/uploaddata/commercial/destroymulti?date=') }}'+deletedates_str
        } 
      }
    });
});
