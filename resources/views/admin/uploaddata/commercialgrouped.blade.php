...
@section('pagetitle')
    <title>Upload Data - Commercial Grouped</title>
@endsection
                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-header">
                      <h4 class="card-title">Commercial Grouped</h4>                    
                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ url('admin/uploaddata/commercialgrouped/upload') }}" class="dropzone" id="upload-dropzone">
                  @csrf
                </form>
              </div>
...
$(document).ready(function() {
    ...
    var table = $('.browse-table').DataTable({
        ...
        serverSide: true,
        ajax:{
          url: '{!! url('admin/uploaddata/commercialgrouped/indexjson') !!}',
          headers: {
        ...
        buttons: [            
            ...
            },
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('admin/uploaddata/commercialgrouped/csvall') }}'
              }
            },
            {
    ...
    $('.buttons-deletemulti').click(function(){
      ...
      if(deletedates_arr.length > 0){
        ...
        if (confirmdelete == true) {
          window.location = '{{ url('admin/uploaddata/commercialgrouped/destroymulti?date=') }}'+deletedates_str
        } 
      }
    });    
});
