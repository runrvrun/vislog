...
@section('pagetitle')
    <title>Upload Data - Spot Unpaired</title>
@endsection
                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-header">
                      <h4 class="card-title">Spot Unpaired</h4>                    
                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ url('admin/uploaddata/spotunpaired/upload') }}" class="dropzone" id="upload-dropzone">
                  @csrf
                </form>
              </div>
...
$(document).ready(function() {
    ...
    var table = $('.browse-table').DataTable({
        ...
        serverSide: true,
        ajax:{
          url: '{!! url('admin/uploaddata/spotunpaired/indexjson') !!}',
          headers: {
        ...
        buttons: [            
            ...
            },
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('admin/uploaddata/spotunpaired/csvall') }}'
              }
            },
            {
