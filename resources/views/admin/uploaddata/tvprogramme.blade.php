...
@section('pagetitle')
    <title>Upload Data - TV Programme</title>
@endsection
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ url('admin/uploaddata/tvprogramme/upload') }}" class="dropzone" id="upload-dropzone">
                  @csrf
                </form>
              </div>
...
$(document).ready(function() {
    ...
    var table = $('.browse-table').DataTable({
        ...
        serverSide: true,
        ajax:{
          url: '{!! url('admin/uploaddata/tvprogramme/indexjson') !!}',
          headers: {
        ...
        buttons: [            
            ...
            },
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('admin/uploaddata/tvprogramme/csvall') }}'
              }
            },
            {
    ...
    $('.buttons-deletemulti').click(function(){
      ...
      if(deletedates_arr.length > 0){
        ...
        if (confirmdelete == true) {
          window.location = '{{ url('admin/uploaddata/tvprogramme/destroymulti?date=') }}'+deletedates_str
        } 
      }
    });
