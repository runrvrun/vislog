...
@section('pagetitle')
    <title>Upload Search Data - Ads Type</title>
@endsection
                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-header">
                      <h4 class="card-title">Ads Type</h4>                    
                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ url('admin/uploadsearch/adstype/upload') }}" class="dropzone" id="upload-dropzone">
                  @csrf
                </form>
              </div>
...
$(document).ready(function() {
    ...
    var table = $('.browse-table').DataTable({
        ...
        serverSide: true,
        ajax:{
          url: '{!! url('admin/uploadsearch/adstype/indexjson') !!}',
          headers: {
        ...
        buttons: [            
            ...
            },
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('admin/uploadsearch/adstype/csvall') }}'
              }
            },
            {
